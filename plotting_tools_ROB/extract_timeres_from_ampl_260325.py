...
def main():
  ...
  if time_res_calc:
    ...
    axes1.legend(fontsize=30, frameon=False, loc='upper left')
    ...
    axes2.legend(fontsize=30, frameon=False, loc='upper left')
    ...
    axes3.legend(fontsize=30, frameon=False, loc='upper left')
