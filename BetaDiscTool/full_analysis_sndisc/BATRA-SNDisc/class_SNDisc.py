...
def differential_programming_SigProbModel(num_epochs, pmax, width, ansatz_pmax_value, learning_rate):
  ...
  return model(max_amplitudes, max_pow).detach().numpy(), max_amplitudes
